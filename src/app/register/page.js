          ...
          <div className="register-card" style={{ flex:1,background:"#fff",padding:"44px 40px",display:"flex",flexDirection:"column" }}>
            ...
            <form onSubmit={handleSubmit} style={{ display:"flex",flexDirection:"column",gap:16 }}>
              ...
              <div className="form-field" style={{ position:"relative" }}>
                ...
                {/* DROPDOWN */}
                {results.length > 0 && (
                  <ul style={{ position:"absolute",width:"100%",zIndex:50,background:"#fff",border:"1.5px solid #dde8de",borderRadius:12,marginTop:6,padding:"6px 0",listStyle:"none",boxShadow:"0 8px 24px rgba(0,0,0,.10)",maxHeight:200,overflowY:"auto",animation:"fade-in .15s ease" }}>
                    {results.map((item) => {
